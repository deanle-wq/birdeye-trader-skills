...
Answer this daily trader job: **What liquid tokens are surging most over five minutes?**
...
Learn the 5-Min Price Surge skill.

From this repository, install the public package:

```bash
npx skills add https://github.com/deanle-wq/birdeye-trader-skills --skill birdeye-5-minute-price-surge
```
...
- Rank liquid Solana tokens by five-minute price change.
- Require at least $10K liquidity and $5K five-minute volume by default.
- Show the move together with volume, trade count, holders, market cap and liquidity so the spike can be checked.

## Just say to your agent

- `Which liquid Solana tokens are pumping hardest over 5 minutes?`
- `Show 5-minute price surges with at least $25K liquidity and $10K volume.`
...
| `--sort-by` | Optional | `price_change_5m_percent` | Provider-supported ranking field. |
...
1. `birdeye-cli market price-surge-5m`
