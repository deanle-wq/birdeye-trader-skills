...
Answer this daily trader job: **What tokens are trading most actively in the last five minutes?**
...
Learn the 5-Min Trending Tokens skill.

From this repository, install the public package:

```bash
npx skills add https://github.com/deanle-wq/birdeye-trader-skills --skill birdeye-5-minute-trending-tokens
```
...
- Rank Solana tokens by five-minute on-chain volume.
- Show price, market cap, liquidity, holder count, five-minute volume and five-minute trade count for each result.
- Filter by market cap, liquidity, holder count, five-minute volume, price change, volume change or trade count before ranking.

## Just say to your agent

- `Show me the most active Solana tokens in the last 5 minutes.`
- `Find 5-minute trending tokens with at least $25K liquidity and $10K volume.`
...
| `--sort-by` | Optional | `volume_5m_usd` | Provider-supported ranking field. |
...
1. `birdeye-cli market trending-5m`
